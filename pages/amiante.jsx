    ...
    <div className={styles.root}>
      ...
      <div className={styles.txt}>
        <p className={styles.txt}>
          ...
          Nous comprenons l’importance de garantir la <strong>sécurité</strong>{" "}
          et la <strong>conformité</strong>, et c’est pourquoi nous mettons en
          avant notre <strong>expertise</strong> en matière de{" "}
