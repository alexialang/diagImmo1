  ...
  return (
    <div>
      ...
      <div className={styles.txt}>
        ...
        <h3>· Validité du DPE :</h3> La <strong className={styles.fontweight}>validité</strong> du DPE est de <strong>10 ans</strong>,<strong> sauf en
       ...
       <strong className={styles.fontweight}> logement</strong> , vous aidant à prendre des décisions éclairées.
        ...
        <p>Besoin de conseils sur les démarches
        ...
        <p>En concevant GPADI, minimisez les
