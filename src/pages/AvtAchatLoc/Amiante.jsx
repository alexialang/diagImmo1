  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.txt}>
        ...
        pour tous vos besoins en <strong>diagnostics immobiliers</strong>. Nous
        comprenons l’importance de garantir la <strong>sécurité</strong> et la{" "}
        <strong>conformité</strong>, et c’est pourquoi nous mettons en avant
        notre <strong>expertise</strong> en matière de{" "}
        <strong>diagnostic</strong> <strong>Amiante</strong>.
        <h2>
        ...
        <p>
          ...
          Il vise à détecter la présence éventuelle d’amiante, un matériau
          dangereux pour la santé, permettant ainsi d’assurer la{" "}
          <strong>sécurité</strong> des occupants.
        </p>
        ...
        <p>
          Chez <strong>GPADI</strong>, nous nous engageons à assurer une totale
          conformité avec les exigences du diagnostic Amiante. Nos
          diagnostiqueurs expérimentés sont formés pour détecter toute présence
          d’amiante et fournir des recommandations appropriées.
        </p>
        ...
        <p className={styles.txtColor}>
          ...
          Amiante ? Contactez-nous dès Aujourd’hui!
        </p>
        <div>
          <Link to="/devis">
            <Button
