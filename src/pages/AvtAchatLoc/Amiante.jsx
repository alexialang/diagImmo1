...
export const Amiante = () => {
  ...
  <div>
    <div className={styles.backgroundImg}>
      <div className={styles.divSize} ><h1>Amiante</h1>
...
<p>Le diagnostic Amiante est une obligation légale visant à protéger la santé publique. Il doit être inclus dans les dossiers de technique de diagnostic lors de la mise en vente ou en localisation.</p>
