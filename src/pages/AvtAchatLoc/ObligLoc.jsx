  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.txt}>
        <p className={styles.txt}>Lors de la mise en location d’un bien immobilier en France, différentes obligations en matière de diagnostics immobiliers doivent être respectées pour garantir la sécurité et l’information des parties prenantes. </p>
        ...
        <p className={styles.txt}>Informe sur les risques naturels, technologiques, et les pollutions du secteur.
        ...
        <p className={styles.txt}>Obligatoire si un arrêté préfectoral ou communal le prescrit.
        ...
        <p className={styles.txt}>Indique la surface habitable du logement loué.
        </p>
        </div>

        <div className={styles.column}>
        <h2>État des Lieux :</h2>
        <p className={styles.txt}>Non un diagnostic, mais une obligation cruciale.
           État des lieux d’entrée et de sortie pour évaluer l’état du logement.
        </p>
        </div>

        <p className={styles.txt}>Le respect de ces obligations assure la conformité légale de la location, protégeant tant le propriétaire que le locataire.<br/> Chaque diagnostic doit être réalisé par des professionnels certifiés, et les résultats doivent être clairement communiqués aux parties concernées.
