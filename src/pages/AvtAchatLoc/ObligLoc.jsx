  ...
  return (
    <div>
      ...
      <div className={styles.txt}>
        <p>
          Bienvenue sur notre page dédiée aux obligations de diagnostics
          immobiliers pour la location avec GPADI. Nous comprenons l’importance
          de vous fournir des informations claires et précises pour garantir une
          location en toute conformité. Découvrez ci-dessous les principales
          obligations de diagnostics immobiliers que vous devez connaître.
        </p>
        ...
        <div className={styles.column}>
          ...
          <p>
            {" "}
            La Loi Boutin impose le mesurage précis de la surface habitable dans
        ...
        <div className={styles.column}>
          ...
          <p>
            {" "}
            Le diagnostic gaz est obligatoire pour les locations de biens
            immobiliers équipés d’une installation de gaz datant de plus de 15
            ans.
          </p>
        </div>
        ...
        <div className={styles.column}>
          ...
          <p>
            {" "}
            Le diagnostic électrique est requis pour les locations de biens
            immobiliers dont l’installation électrique a plus de 15 ans.
          </p>
        </div>
        ...
        <p>
          Nous chez GPADI, nous sommes là pour vous accompagner à travers ces
          démarches. N’hésitez pas à nous contacter pour obtenir des conseils
          personnalisés et des devis adaptés à vos besoins. Garantissez une
          location en toute tranquillité et conformité avec nos services de
