    ...
    <div>
      ...
      <div className={styles.txt}>
        <p>
          ...
          en matière de Diagnostic ERP (État des Risques et Pollutions).
        </p>
        <h2>Qu’est-ce que le Diagnostic ERP ?</h2>
        <p>
          Le Diagnostic ERP, également appelé ERNMT (État des Risques Naturels,
          Miniers et Technologiques), est une étape essentielle lors de la vente
          ou de la location d’un bien immobilier. Il vise à informer les futurs
          occupants des risques potentiels liés à la localisation du bien en
          termes de risques naturels, miniers, technologiques, et d’autres
          pollutions.
        </p>
        ...
        <p>
          {" "}
          Le Diagnostic ERP est une obligation légale lors de la vente ou de la
          location d’un bien immobilier. Il doit être inclus dans les dossiers
          de diagnostic technique.
        </p>
        <h3>Validité du Diagnostic :</h3>{" "}
        <p>
          La validité du Diagnostic ERP est de six mois. Une mise à jour est
        ...
        <p>
          ...
          les normes en vigueur pour le Diagnostic ERP. Nos diagnostiqueurs
        ...
        <p>
          ...
          dans la réalisation de diagnostics ERP conformes aux normes en
          vigueur.
          <br />
          <br />
          Conseils Personnalisés : Besoin de conseils sur les démarches à suivre
          en cas de risques identifiés ? Notre équipe est là pour vous guider.
          <br />
          <br />
          Minimisation des Risques : En choisissant GPADI, minimisez les risques
          liés à la localisation de votre bien, assurant ainsi la sécurité et la
          tranquillité d’esprit des occupants.
        </p>
        <p className={styles.txtColor}>
          Besoin d’un DEVIS pour votre diagnostic immobilier ERP ?
