  ...
  return (
    <div>
      ...
      <div className={styles.txt}>
        ...
        matière de Diagnostic Gaz.
        <h2>Qu’est-ce que le Diagnostic Gaz ?</h2>
        <p>
          Le diagnostic Gaz est une étape cruciale lors de la vente ou de la
          location d’un bien immobilier. Il vise à évaluer la conformité et la
          sécurité des installations de gaz, assurant ainsi la protection des
          occupants contre les risques liés au gaz.
        </p>
        <h2>Obligations et Dates Importantes</h2>
        <h3>Obligation Légale :</h3>
        <p>
          {" "}
          Le diagnostic Gaz est une obligation légale lors de la vente d’un bien
          immobilier avec une installation de gaz datant de plus de 15 ans. Il
          doit être inclus dans les dossiers de diagnostic technique.
        </p>
        <h3>Validité du Diagnostic :</h3>
        <p>
          {" "}
          La validité du diagnostic Gaz est de 3 ans. Une mise à jour est
          nécessaire en cas de modifications importantes des installations de
          gaz ou en cas de vente ou de location après la période de validité.
        </p>
        ...
        <p>
          ...
          experts dans la réalisation de diagnostics Gaz conformes aux normes en
          vigueur.
          <br />
          <br />
        ...
        <p className={styles.txtColor}>
          Besoin d’un DEVIS pour votre diagnostic immobilier Gaz ?
