    ...
    <div>
      ...
      <div className={styles.txt}>
        <p>
          ...
          en matière de Diagnostic Plomb.
        </p>
        <h2>Qu’est-ce que le Diagnostic Plomb ?</h2>
        <p>
          Le diagnostic Plomb, également appelé Crep (Constat de Risque
          d’Exposition au Plomb), est une étape cruciale lors de la vente ou de
          la location d’un bien immobilier construit avant le 1er janvier 1949.
          Il vise à évaluer la présence éventuelle de plomb, un matériau
          toxique, dans les revêtements intérieurs du logement.
        </p>
        <h2>Obligations et Dates Importantes</h2>
        <h3>Obligation Légale :</h3>{" "}
        <p>
          Le diagnostic Plomb est une obligation légale lors de la vente ou de
          la location d’un bien immobilier construit avant le 1er janvier 1949.
          Il doit être inclus dans les dossiers de diagnostic technique.
        </p>
        <h3>Validité du Diagnostic :</h3>{" "}
        <p>
          La validité du diagnostic Plomb est illimitée, à moins que des travaux
        ...
        <p>
          ...
          les normes en vigueur pour le diagnostic Plomb. Nos diagnostiqueurs
          expérimentés sont formés pour détecter toute présence de plomb et
        ...
        <p>
          ...
          suivre en cas de présence de plomb ? Notre équipe est là pour vous
          guider.
          <br />
        ...
        <p className={styles.txtColor}>
          Besoin d’un DEVIS pour votre diagnostic immobilier Plomb ?
